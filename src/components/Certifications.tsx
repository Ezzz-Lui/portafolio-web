      ...
      <CardContent className="p-6 relative z-10">
        ...
        <div className="space-y-4">
          {certifications.map((cert, index) => (
            <Card key={index} className="bg-gradient-to-br border-hidden from-white via-zinc-100 to-white dark:from-black dark:via-yellow-950 dark:to-yellow-600 rounded-lg shadow-md animate-subtle-wave border border-neon-blue">
