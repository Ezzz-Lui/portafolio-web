...
export function Projects() {
  return (
    <Card id='projects' className="col-span-full border-hidden bg-gradient-to-br from-white via-gray-100 to-gray-200 dark:from-stone-950 dark:via-stone-900 dark:to-stone-950 rounded-3xl shadow-lg backdrop-blur-sm bg-opacity-50">
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {projects.map((project, index) => (
            <Card key={index} className="border-hidden bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-stone-950 dark:via-stone-950 dark:to-stone-950 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
