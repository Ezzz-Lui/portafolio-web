...
export function Projects() {
  return (
    <Card id='projects' className="col-span-full border-hidden bg-gradient-to-br from-white via-gray-100 to-gray-200 dark:from-black dark:via-zinc-950 dark:to-black rounded-3xl shadow-lg backdrop-blur-sm bg-opacity-50">
