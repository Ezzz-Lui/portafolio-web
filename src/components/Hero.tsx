  ...
  return (
    <Card className="rounded-3xl shadow-lg overflow-hidden relative border-hidden">
      <CardContent className="relative z-10 p-6 md:p-12">
        <h1 className="text-4xl md:text-6xl font-extrabold mb-4 dark:text-transparent dark:bg-clip-text dark:bg-gradient-to-r dark:from-stone-950 dark:via-stone-900 dark:to-stone-950 dark:animate-text-shimmer">
        ...
        <div className="flex flex-wrap justify-center md:justify-start items-center gap-2 md:gap-6 mb-4">
            <Button asChild variant="link" size="lg" className="rounded-full dark:bg-gradient-to-r dark:from-stone-950 dark:via-zinc-900 dark:to-stone-950 bg-gray-100 dark:bg-zinc-800 text-black dark:text-white border-zinc-700 hover:bg-zinc-950 hover:text-zinc-100 transition-colors duration-300" >
              <Link href="https://github.com/Ezzz-Lui" target='_blank'>
                <GithubIcon className="h-5 w-5" />
              </Link>
            </Button>
            <Button asChild variant="link" size="lg" className="rounded-full dark:bg-gradient-to-r dark:from-stone-950 dark:via-zinc-900 dark:to-stone-950 bg-gray-100 dark:bg-zinc-800 text-black dark:text-white border-zinc-700 hover:bg-blue-700 hover:text-zinc-100 transition-colors duration-300">
              <Link href="https://www.linkedin.com/in/lk-ramos" target='_blank'>
                <LinkedIn className="h-5 w-5" />
              </Link>
            </Button>
            <Button asChild variant="link" size="lg" className="rounded-full dark:bg-gradient-to-r dark:from-stone-950 dark:via-zinc-900 dark:to-stone-950 bg-gray-100 dark:bg-zinc-800 text-black dark:text-white border-zinc-700 hover:bg-zinc-700 hover:text-zinc-100 transition-colors duration-300">
              <Link href="/cv.pdf" target='_blank'>
                <FileText className="h-5 w-5 " />
              </Link>
            </Button>
            <Button asChild variant="link" size="lg" className="rounded-full dark:bg-gradient-to-r dark:from-stone-950 dark:via-zinc-900 dark:to-stone-950 bg-gray-100 dark:bg-zinc-800 text-black dark:text-white border-zinc-700 hover:bg-teal-700 hover:text-zinc-100 transition-colors duration-300">
