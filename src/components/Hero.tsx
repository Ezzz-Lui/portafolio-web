    ...
    <Card className="col-span-full rounded-3xl shadow-lg overflow-hidden relative border-hidden">
      <div className="absolute dark:inset-0 dark:bg-gradient-to-br dark:from-black dark:to-zinc-950 dark:animate-gradient-x">
        <div className="absolute inset-0 opacity-30">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-black via-zinc-950 to-black animate-pulse"></div>
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_var(--tw-gradient-stops))] from-black via-zinc-400 to-transparent animate-pulse delay-150"></div>
        </div>
      ...
      <CardContent className="relative z-10 p-6 md:p-12">
        ...
        <div className='space-x-0 space-y-4 md:space-x-6 md:space-y-0 flex flex-col md:flex-row'>
          <Button variant="link" size="lg" className="rounded-full bg-zinc-800 text-white border-zinc-700 hover:bg-zinc-950 hover:text-zinc-100 transition-colors duration-300">
            <GithubIcon className="h-5 w-5" />
          </Button>
          <Button variant="link" size="lg" className="rounded-full bg-zinc-800 text-white border-zinc-700 hover:bg-blue-700 hover:text-zinc-100 transition-colors duration-300">
            <LinkedIn className="h-5 w-5 " />
          </Button>
          <Button variant="link" size="lg" className="rounded-full bg-zinc-800 text-white border-zinc-700 hover:bg-zinc-700 hover:text-zinc-100 transition-colors duration-300">
            <FileText className="h-5 w-5 " />
          </Button>
          <Button variant="link" size="lg" className="rounded-full bg-zinc-800 text-white border-zinc-700 hover:bg-teal-700 hover:text-zinc-100 transition-colors duration-300">
